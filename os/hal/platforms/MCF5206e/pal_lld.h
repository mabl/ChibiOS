 ...
 *       code.
 */
#define pal_lld_readport(port) ((port)->PPDAT)
 ...
 *       code.
 */
#define pal_lld_readlatch(port) ((port)->PPDAT)
 ...
 *       code.
 */
#define pal_lld_writeport(port, bits) ((port)->PPDAT = bits)
