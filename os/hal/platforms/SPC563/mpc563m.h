/**************************************************************************/
/* FILE NAME: mpc563m.h                      COPYRIGHT (c) Freescale 2008 */
        ...
        union {                 /* Module Configuration Register */
            ...
            struct {
                ...
                vuint32_t PEG:1;
                  ...
                  vuint32_t:1;
                vuint32_t PRD:1;        /* Include PRD Field */
    ...
    struct XBAR_tag {
        union {
            ...
            struct {
                ...
                vuint32_t:1;
                vuint32_t MSTR4:3;      /* Z3 core data and Nexus */
...
/****************************************************************************/
    struct INTC_tag {
        ...
        } PSR[361];             /* Software Set/Clear Interrupt Register */
...
/****************************************************************************/
    struct DECFIL_tag {
        ...
        } COEF[9];              /* Filter Coefficient Registers */
...
/****************************************************************************/
    struct STM_tag {
        ...
        union {
            vuint32_t R;
        } CNT;                  /* STM Counter Value */

        uint32_t stm_reserved1[2];
        ...
        } CCR0;                 /* STM Channel 0 Control Register */
        ...
        } CIR0;                 /* STM Channel 0 Interrupt Register */

        union {
            vuint32_t R;
        } CMP0;                 /* STM Channel 0 Compare Register */

        uint32_t stm_reserved2;
        ...
        } CCR1;                 /* STM Channel 0 Control Register */
        ...
        } CIR1;                 /* STM Channel 0 Interrupt Register */

        union {
            vuint32_t R;
        } CMP1;                 /* STM Channel 0 Compare Register */

        uint32_t stm_reserved3;
        ...
        } CCR2;                 /* STM Channel 0 Control Register */
        ...
        } CIR2;                 /* STM Channel 0 Interrupt Register */

        union {
            vuint32_t R;
        } CMP2;                 /* STM Channel 0 Compare Register */

        uint32_t stm_reserved4;
        ...
        } CCR3;                 /* STM Channel 0 Control Register */
        ...
        } CIR3;                 /* STM Channel 0 Interrupt Register */

        union {
            vuint32_t R;
        } CMP3;                 /* STM Channel 0 Compare Register */

        uint32_t stm_reserved5;
    };
/****************************************************************************/
/*                     MODULE : Software Watchdog Timer (SWT)               */
/****************************************************************************/
    struct SWT_tag {
        union {
            vuint32_t R;
...
/****************************************************************************/
    struct PMC_tag {
        ...
        } CFGR;                 /* Configuration and status register */

        union {
            vuint32_t R;
            struct {
                vuint32_t:12;
                vuint32_t LVI50TRIM:4;
                vuint32_t V33TRIM:4;
                vuint32_t LVI33TRIM:4;
                vuint32_t V12TRIM:4;
                vuint32_t LVI12TRIM:4;
            } B;
...
#define PBRIDGE (*( struct PBRIDGE_tag *)              0xFFF00000)
