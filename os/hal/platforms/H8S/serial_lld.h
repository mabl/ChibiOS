...
/**
 * @file H8S/serial_lld.h
 * @brief H8S low level serial driver header.
 ...
 */
#if !defined(USE_H8S_UART1) || defined(__DOXYGEN__)
#define USE_H8S_USART1 TRUE
#endif
 ...
 */
#if !defined(USE_H8S_UART2) || defined(__DOXYGEN__)
#define USE_H9S_USART2 FALSE
#endif
