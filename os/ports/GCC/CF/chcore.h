...
/**
 * Macro defining the COLDFIRE architecture.
 */
...
/**
 * In the COLDFIRE port this structure just holds a pointer to the @p intctx
...
#define PORT_IRQ_EPILOGUE() {													\
	if (chSchRescRequiredI())													\
		chSchDoRescheduleI();													\
	asm volatile (	"moveml		%sp@,%d0-%d1/%a0-%a1 					\n\t"	\
					"lea		%sp@(16), %sp							\n\t"	\
					"rte												\n\t");	\
}
*/
